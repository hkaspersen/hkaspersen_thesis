...
Here, the main results from paper I - III is discussed in context of the main aims of the project.

### Summarise and describe existing data on occurrence of quinolone resistance

Use of quinolones in Norwegian livestock is generally low, which is reflected in the overall low occurrence of QREC in multiple animal species compared to other countries in Europe [@EFSA2019]. The selective method introduced in the surveillance program in 2014 revealed a high proportion of QREC-positive samples. However, no quantification of the presence of QREC have yet been done in these samples. 
