...
PMQR was detected in only 21% of the QREC isolates in article II and none of the isolates in article III. This is in concordance with other studies in Europe [@Veldman2011;@Borjesson2015;@deJong2018;@Wasyl2018]. _qnr_-genes have regularly been found on plasmids bearing additional resistance genes, such as extended spectrum $\beta$-lactamases (ESBL) [@Martinez-Martinez1998;@Wang2003;@Robicsek2006a;@Strahilevitz2009;@Jacoby2006a;@Zurfluh2015d]. The isolates in the present study had a low occurrence of ESBL and other resistance genes conferring resistance to antimicrobial types other than quinolones. These results may indicate that quinolone resistance gene-bearing plasmids are rare in these animal populations in Norway, and only play a small role in the occurence of quinolone resistance in these animals environments.

Amino acid substitutions in mutator proteins were detected by comparing to the K12 version of each respective protein. Multiple substitutions were detected, and a positive correlation was found between altered proteins and phenotype. Furthermore, the odds for an isolate being resistant increased with increasing number of altered mutator proteins (see article III). These results may indicate that alterations in mutator proteins may have en effect on the development of quinolone resistance in _E. coli_, as the mutation rate may increase with defects in the various DNA repair systems such as MMR. However, further studies are needed to ascertain whether the identified amino acid substitutions in these proteins have an effect on the mutation rate. 


### Possible associations between isolates from various origins

The initial hypothesis on the source of the observed QREC occurrence in broilers was dissemination of existing QREC isolates from imported breeding animals. This was previously hypothesized in studies from Sweden, Norway and Iceland [@Myrenaas2018;@Borjesson2015]. In the present study, possible associations between isolates were determined by comparing sequence types, associating epidemiological data, and phylogenetic analysis. In short, the results suggests the dissemination of major STs through the broiler production chain, and little development of quinolone resistance among wild type _E. coli_. Furthermore, phylogenetically related isolates were detected among broilers and red foxes, from geograhically distant locations and from different years.

The major STs identified among QREC isolates from broilers were ST10, ST349 and ST355. These STs have previously been identified as major STs of QREC isolates in samples from broilers in Norway, Sweden and Iceland [@Myrenaas2018]. The broiler production environment is a highly stable environment with little temperature changes, closed to the outside, and is populated by a single animal species. It is therefore plausible to think that isolates within this environment have little reason to change, due to its stable nature. These major STs may therefore represent isolates that are highly adapted to the broiler production environment, and is likely to persist if introduced through imported animals. However, parent animals are imported to Norway from Sweden, which is a country much like Norway in regards to quinolone usage. The overall sale of quinolones for animal use in Sweden have dropped 82% since 2009, and only 29 kg of active substance was sold in 2018 [@SWEDRES2019]. Additionally, a Swedish study have implicated imported breeding birds as the plausible source of QREC in their broiler production chain [@Borjesson2015]. This indicate that QREC isolates may originate from the top of the pyramid. Grandparent animals are imported from Scotland to Sweden, but no data on QREC occurrence or quinolone usage is available from this section of the production pyramid.


Phylogenetically related isolates from pigs were identified in Article II. These were isolates from geographically distant location, but within the same year.



The identification of phylogenetically related QREC from broilers and red foxes in Article II was a surprising finding, and indicated persistence in the broiler production chain. 
...
Since these isolates were isolated from healthy broilers, it is likely that they do not cause disease and may be part of the normal flora of these broilers. 
...
Emergence of QREC is attributed to either dissemination of exogenous strains, or spontaneous development in the gut microbiota [@HUANG2014]. The results from article 2 indicates that the emergence of QREC in the broiler and pig production chain may be linked to dissemination rather than spontaneous development. This is not unexpected, as negligible amounts of quinolones are used in these production compartments. However, quinolones themselves are mutagenic [@Ysern1990], and a single treatment with this class of antimicrobials have shown to increase the occurrence of QREC in the animal gut <!-- ref -->. 
