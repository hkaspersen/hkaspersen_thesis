...
### Swine production
Swine production in Norway also has a pyramidal structure with unidirectional flow of animals, similar to the broiler production [@Kristoffersen2016]. However, the import of live pigs from other countries to the commercial pig population is negligible [@Animalia2018]. The genetic nucleus herds, where the purebred grand parent animals are produced, are at the top of the pyramid. Hybrid parent animals are produced in multiplier herds, either by recruiting purebred animals from the nucleus herds or having a self-recruitment strategy. These animals are distributed to multiplier herds, where parent animals are produced. These parent sows are either kept on integrated farms (with farrow to finish production) or on specialized farms producing fattening pigs.
Gilts from the multiplier herds are distributed to piglet producing herds (either farrow to finish or farrow to grower herds). Additionally, sow pool systems with central units are used. Here, sows are inseminated and kept for the majority of the gestation period up until approx. three weeks before parturition. At this time, the sows are moved to satellite units of the sow pool system where they are kept before being moved back to the central unit after the piglets have been weaned. The piglet producing herds have a mean weaning age of 33 days, followed by a growing stage until the grower pig is approx. 30 kg and 10-11 weeks of age. The grower pig is then transferred to a fattening unit at the same farm or to a specialized fattening pig farm. In general, the distribution of fattening pigs is shorter in geographic distance compared to parent and grandparent animals. Specific concession limits regulates the maximum amount of animals allowed at a farm at any given time (Carl Andreas Grøntvedt, personal communication, 19.08.2019).
...
When working with databases, one should be aware of the limitations they infer on the resulting data. In the case of acquired resistance, one can only identify the genes which are included in the database. Potential novel genes may therefore be missed. In the case of mutations in intrinsic genes, all genes of interest in this study was included in the database used. However, whether or not the identified mutations have been induced or are naturally present in their respective environment of origin is not simple to deduce. Some mutations in different lineages of _E. coli_ have been found to be selectively neutral, and may not have been induced by selective pressure.
