...
In broilers, the occurrence of QREC seem to be relatively stable in Europe the last eight years (Figure \@ref(fig:broilertrend)). More and more countries are doing surveillance after the introduction of mandatory surveillance from the EU in 2014.


```{r, fig.cap="\\label{fig:broilertrend}Occurrence of quinolone resistant E. coli isolated from broilers in Europe from 2011 to 2016. Grey areas represent missing data. Data taken from European Union summary reports on antimicrobial resistance in zoonotic and indicator bacteria from humans, animals and food 2011 - 2016 \\citep{Food2013,Food2014,Food2015,Food2016,Food2017,Food2018}. Illustration: H. Kaspersen.", echo=FALSE, message=FALSE, fig.pos="H", fig.align="center", out.width="15cm"}
knitr::include_graphics("images/broiler_trend.png")
```
