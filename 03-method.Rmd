...
![Flowchart of assembly and annotation pipeline. Yellow rectangle: Analysis on the Abel cluster, with important program settings listed. Turquoise ellipses: Analyses in R. Green folders: Output data. Illustration: H. Kaspersen. \label{fig:assembly}](images/assembly_pipeline.png){width=40%}
