...
![Flowchart of phylogenetic methods. Left: Phylogenetic analysis for all isolates. Right: Phylogenetic analysis for selected clades. Purple folders represent input data. Beige boxes represent bioinformatic tools used in Linux. Turquise circles represent analyses in R. Yellow folders represent output data. Illustration: H. Kaspersen \label{fig:flowchart}](images/flowchart.png)
