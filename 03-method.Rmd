...
```{r, fig.cap="\\label{fig:mapping}Overview of the ARIBA mapping and targeted assembly pipeline, reprinted from Hunt et al. 2017 \\citep{Hunt2017} with permission from Microbiology Society.", echo=FALSE, message=FALSE, fig.pos="H", fig.align="center", out.width="70%",out.height="70%"}
