...
```{r, fig.cap="\\label{fig:flowchart}Flowchart of phylogenetic methods. Left: Phylogenetic analysis for all isolates. Right: Phylogenetic analysis for selected clades. Purple folders represent input data. Beige boxes represent bioinformatic tools used in Linux. Turquoise circles represent analyses in R. Yellow folders represent output data. Illustration: H. Kaspersen", echo=FALSE, message=FALSE, fig.pos="H", fig.align="center", out.width="99%"}
