...
```{r, fig.cap="\\label{fig:quinUsage}Overall sales, in kg active substance, of quinolones and macrolides for therapeutic use in terrestrial livestock animals in Norway in 1993 - 2017, taken from the NORM/NORM-VET 2017 report", echo=FALSE, message=FALSE, fig.align='center'}
...
```{r, fig.cap="\\label{fig:popstructure}Phylogenetic history of \\textit{Escherichia coli}, reprinted with permission from Springer Nature", out.width="14cm", out.height="14cm", echo=FALSE, message=FALSE, fig.align='center'}
...
```{r, fig.cap="\\label{fig:watermetalion}Overview of the water-metal ion bridge that mediates the quinolone-topoisomerase IV interaction, reprinted with permission from the American Chemical Society,", out.width="8cm", out.height="8cm", echo=FALSE, message=FALSE, fig.align='center'}
