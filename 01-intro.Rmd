...
```{r, fig.cap="\\label{fig:quinUsage}Overall sales, in kg active substance, of quinolones and macrolides for therapeutic use in terrestrial livestock animals in Norway in 1993 - 2017 \\citep{NORM/NORM-VET2017}", echo=FALSE, message=FALSE, fig.align='center'}
