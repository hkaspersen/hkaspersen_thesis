...
In Norway, the use of quinolones in livestock is very low, see Figure \@ref(fig:quinUsage).

```{r, fig.cap="\\label{fig:quinUsage}Overall sales, in kg active substance, of quinolones and macrolides for therapeutic use in terrestrial livestock animals in Norway in 1993 - 2017", echo=FALSE, message=FALSE, fig.align='center'}
...
```{r, fig.cap="\\label{fig:qrecEpi}Percent occurrence of QREC per animal species", echo=FALSE, message=FALSE, fig.pos="H", fig.align="center"}
